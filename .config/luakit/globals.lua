...
search_engines = {
    ...
    d   = "http://duckduckgo.com/?q=%s&ka=n&kl=cz-cs&kp=-1&kf=-1&kg=p&km=l&kt=n&ko=s&k4=-1&ke=-1&kr=-1&k1=-1",
    aur = "https://aur.archlinux.org/packages.php?O=0&K=%s&do_Search=Go",
    pkg = "http://www.archlinux.org/packages/?sort=&arch=i686&q=%s&maintainer=&last_update=&flagged=&limit=50",
    aw  = "https://wiki.archlinux.org/index.php?search=%s",
    u   = "http://uloz.to/hledej/?q=%s",
